	...
	$.fn.kinMaxShow = function(user_options){
			...
			var default_options = {
						...
						button:{
								...
								normal:{width:'14px',height:'14px',lineHeight:'14px',left:'45%',bottom:'10px',fontSize:'10px',background:"#cccaca",border:"1px solid #ffffff",color:"#666666",textAlign:'center',marginRight:'8px',fontFamily:"Verdana",float:'left'},
								//当前 按钮样式
